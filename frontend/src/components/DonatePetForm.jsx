...
const DonatePetForm = () => {
  ...
  return (
    <div className=" bg-primaryYellow/5 p-4 ">
      <div className="bg-white w-full  rounded-3xl  p-8 flex  gap-3 justify-between items-center">
        <h2 className=" font-bold mb-6 text-textGray text-center text-6xl">
          Donate a Pet
        </h2>
        <form onSubmit={handleSubmit(onSubmit)} className=" w-xl">
          <h1 className="font-bold mb-6 text-textGray text-center text-xl">
            Fill The Form to Donate Pet
          </h1>
          <div className="flex  gap-5 items-center  ">
            <div
              ref={dropzoneRef}
              className="w-[400px] h-max relative border-2 border-gray-300 border-dashed rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer"
